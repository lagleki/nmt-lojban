...
with open('epoch_42_structure.json') as f:
    z = f.read()

K.set_image_dim_ordering('th')
th_dim_model = model_from_json(z)
th_dim_model.load_weights('epoch_42_weights.h5')

K.set_image_dim_ordering('tf')
tf_dim_model = model_from_json(jsn)

model_weights = ['epoch_42_weights.h5']
